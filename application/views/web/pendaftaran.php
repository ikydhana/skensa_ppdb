...
<head>
    ...
    <title>PPDB SMK NEGERI 1 BANJARBARU</title>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> SMK Negeri 1 Banjarbaru</strong></h2>
                  ...
                  <div class="tab-pane active" id="style">
                    ...
                    <div class="wizard-div current wizard-sea" id="register">
                      <form role="form" class="wizard wizard-validation" data-style="sea" role="form" action="" enctype="multipart/form-data"  method="post">
                        ...
                        <fieldset>
                            <legend>Jenis Pendaftaran</legend>
                            <div class="row">
                              <div class="col-md-2"></div>
                              <div class="col-md-8">
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses PPDB Online SMK Negeri 1 Banjarbaru hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="http://www.sman1belitang.sch.id" target="_blank">SMK 1 Banjarbaru</a> <?php echo date('Y'); ?> | IT Development</span>
              </p>
