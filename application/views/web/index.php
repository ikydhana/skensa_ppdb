...
<head>
    ...
    <title>PPDB Online | SMK Negeri 1 Banjarbaru</title>
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <div class="intro-text"><br>
                        <span class="name shad" style="font-size:35px">PPDB ONLINE <br> SMK Negeri 1 Banjarbaru</span>
                      ...
                      <?php if ($web_ppdb->status_ppdb == 'buka') {?>
                        ...
                        <hr class="star-light">
												<br>
                        <!-- <h3>Login Calon Siswa Terdaftar di PPDB Online SMK Negeri 1 Banjarbaru</h3> -->
                        <span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 portfolio-item">
                    <a href="http://smkn1banjarbaru.sch.id" target="_blank" class="portfolio-link">
                        <div class="caption">
                        ...
                        <span class="btn btn-success btn-block">smkn1banjarbaru.sch.id</span>
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify">
                    <p>SMK Negeri 1 Banjarbaru menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                    dan bisa dilakukan dimanapun dan kapanpun selama sesi PPDB Online dibuka. Proses pendaftaran calon siswa baru tidak menggunakan formulir konvensional hanya dengan mengakses website PPDB Online SMK Negeri 1 Banjarbaru. </p>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="col-lg-12 text-center">
                                ...
                                <li>Calon Siswa mendaftarkan diri atau melakukan <b><a href="pendaftaran">Pendaftaran PPDB <i>online</i></a></b> melalui website <b><a href="">PPDB SMK Negeri 1 Banjarbaru</a></b>.</li>
                                <li>Setelah Calon Siswa berhasil melakukan pendaftaran, Calon siswa wajib melakukan <b>Print Out Pendaftaran & Mempersiapkan Kelengkapan Berkas PPDB SMK Negeri 1 Banjarbaru</b>.</li>
                                <li>Calon siswa datang ke SMK Negeri 1 Banjarbaru untuk <b>VERIFIKASI</b>, membawa <b>Bukti pendaftaran & Kelengkapan Berkas PPDB SMK Negeri 1 Banjarbaru</b>. </li>
                                ...
                                <li>Jika Calon Siswa sudah mengambil <b>NOMOR TEST & Pengecekan Ruang Ujian</b> selanjutnya Calon Siswa wajib melakukan <b>TEST tertulis POTENSI AKADEMIK</b>.</li>
																<li>PENGUMUMAN HASIL PPDB Online bisa dilihat di Web PPDB SMK Negeri 1 Banjarbaru. Untuk <b>No. Pendaftaran</b> sesuaikan dengan <b>Formulir No. Pendaftaran</b> & <b>Passwordnya</b> yaitu <b>NISN</b> Calon Siswa tersebut.</li>
																<li>Jika Calon Siswa dinyatakan <b>LULUS</b> maka Calon Siswa Wajib <b>Registrasi/Daftar Ulang</b> di <b>SMK Negeri 1 Banjarbaru</b>.</li>
															</ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row" style="margin-top:-100px;margin-bottom:-105px;">
                <div class="col-lg-4 text-center">
                  <br><br>
                    ...
                    <hr class="star-light">
                    <h4>
                    Jl. Ahmad Yani KM. 32, 5, Loktabat Selatan, Banjarbaru Selatan, Kota Banjar Baru, Kalimantan Selatan 70721 <br><br>
                    </h4>
                    <span style="color:#222;"><b><i class="fa fa-phone-square"></i> 0821-5099-8745</b> </span>
										&nbsp;
                    <span class="eml" style="color:#222;"><i class="fa fa-envelope"></i> skensa.banjarbaru@gmail.com</span>
                    <br>
                    <a href="http://smkn1banjarbaru.sch.id" target="_blank"><h4 class="btn btn-success">SMK Negeri 1 Banjarbaru </h4></a>
                </div>
                <div class="col-lg-8 text-center">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3982.600482649524!2d114.81216511475814!3d-3.4469113974911494!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de686c7ab54f285%3A0x5c97b733b95a6085!2sSMK%20NEGERI%201%20BANJARBARU!5e0!3m2!1sid!2sid!4v1682644959294!5m2!1sid!2sid" width="100%" height="465" frameborder="0" style="border:0" allowfullscreen></iframe>
              	</div>
            </div>
        <!-- </div> -->
    </section>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; <a href="http://smkn1banjarbaru.sch.id" target="_blank">SMK Negeri 1 Banjarbaru</a> <?php echo date('Y'); ?> | IT Development
                    </div>
                </div>
            </div>
        </div>
